...
import com.zyflool.coronatracker.MyApp;
...
public final class SPUtils {
    ...
    private SPUtils(final String spName) {
        sp = MyApp.getAppContext().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }

    private SPUtils(final String spName, final int mode) {
        sp = MyApp.getAppContext().getSharedPreferences(spName, mode);
    }
